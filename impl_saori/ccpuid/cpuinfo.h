...
typedef struct CPUID_01_ValuesInEBX
{
	unsigned int	iBrandIndex        : 8;
	unsigned int	iCLFLUSHLineSize   : 8;
	unsigned int	iLogicalProcessors : 8;
	unsigned int	iInitialAPICID     : 8;
} CPUID_01_EBX_t;
...
extern	CPUID_01_EBX_t	uBasic2Flags;
extern	CPUID_01_ECX_t	uExtFlags;
extern	CPUID_01_EDX_t	uExt2Flags;
extern	CPUID_02_t	uTLBDesc1;
extern	CPUID_02_t	uTLBDesc2;
extern	CPUID_02_t	uTLBDesc3;
extern	CPUID_02_t	uTLBDesc4;
